...
#check where the transition period occurs...


#plot the IGT classic way


#plot the mean of the bottom three gammares


#try an even more sensitive value (something like 20 of the last 30 are active)