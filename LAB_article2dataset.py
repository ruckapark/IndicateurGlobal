...
if __name__ == '__main__':
    ...
    substances = ['Cuivre','Zinc','Methomyl','Lindane','alphaEndosulfan','betaEndosulfan']
    concentrations = dict(zip(substances[:3],['100ug','324ug','125ug']))
    dope_df = dope_df[dope_df['Substance'].isin(substances)]
