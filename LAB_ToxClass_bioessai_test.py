...
class ToxPLOT:
    ...
    def plotIGT(self,spec = None,short = True,mins = False):
...
if __name__ == '__main__':
    ...
    #if no csv file read as xls and write csv file
    #data = xls_tocsvDATA(r'I:\TXM766-PC\20210520-225527')
    
    #assuming csv file exists, xls file can be used.
    data = csvDATA(r'I:\TXM760-PC\20231215-163118',dope_df)
    
    #if missing a historical archive somewhere
    #data = csvDATA_comp({'E':r'I:\TXM...','G':r'I:\TXM7...','R':r'I:\TXM76...'})
