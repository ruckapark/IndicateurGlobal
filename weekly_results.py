...
Tox,species,etude_ = 766,'G','Etude011'
...
# need to go through this and check this is the best way to do it (check remove organism terrain)
...
no_xticks = 10
xticks = [df_dist.index[i*len(df_dist)//no_xticks] for i in range(no_xticks)]
